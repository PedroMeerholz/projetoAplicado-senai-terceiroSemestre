                ...
                <tbody class="conteudo-tabela-consulta">
                    <?php foreach($consulta as $registro):?>
                        <tr>
                            ...
                            <td><a class="acoes-consulta" href="?router=ManterVeiculo/editaVeiculo/&id=<?php echo base64_encode($registro['id_veiculo']);?>">Editar</a></td>
                            <td><a class="acoes-consulta" href="?router=ManterVeiculo/deletaVeiculo/&id=<?php echo base64_encode($registro['id_veiculo']);?>&placa=<?php echo base64_encode($registro['placa'])?>">Remover</a></td>
                        </tr>
                    <?php endforeach;?>
                </tbody>
            </table>
